...
function Security_employ () {
    ...
    <div className="billing_element">
      <form className="billingForm">
        <input className="billing_textInput" type="password" name="password" placeholder="Current Password"/>
        <input className="billing_textInput" type="password" name="new_password" placeholder="New Password"/>
        <input className="billing_textInput" type="password" name="confirm_password" placeholder="Confirm New Password"/>
      </form>
    </div>
