        ...
        <div className="postjob_container">
            ...
            <div className="postjob_header">
                ...
                <div className="postjob_header_input">
                    <input className="headline_textInput" type="text" name="title" onChange = {handleInput} placeholder=""/>
                </div>
            </div>
            <div className="postjob_body">
                ...
                <textarea className="describe_textInput" type="textarea" onChange = {handleInput}name="description" placeholder="Have a job description ?"/>
                </div>
                </div>
                ...
                <div className="postjob_body_input">
                <select name ="type" onChange = {handleInput} class="form-select" aria-label="Default select example">
